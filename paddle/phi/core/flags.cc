...
PHI_DEFINE_EXPORTED_bool(enable_nvtx, false, "");
 ...
 */
PHI_DEFINE_EXPORTED_bool(use_cutlass_fmha, false, "");

/**
 * Use cublaslt in attn_gemm
 */
PHI_DEFINE_EXPORTED_bool(use_cublaslt_attn_gemm, false, "");

PHI_DEFINE_EXPORTED_int64(custom_allreduce_one_shot_threshold, -1, ""); // 196608
PHI_DEFINE_EXPORTED_int64(custom_allreduce_two_shot_threshold, -1, ""); // 50331648
