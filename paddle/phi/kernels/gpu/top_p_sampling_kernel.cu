...
// #pragma unroll
    ...
    //     printf("topp: %f, prob_now: %f, prob_id: %d, sum_prob: %f.\n",
    //         rand_top_p, (float)(beam_max[i].v), (int)(beam_max[i].id), sum_prob);
