...
class FusedMultiTransformerDyquantOp : public framework::OperatorWithKernel {
 private:
  static constexpr const char *OpName = "FusedMultiTransformerDyquantOp";
...
class FusedMultiTransformerDyquantOpOpMaker
...
REGISTER_OPERATOR(
    fused_multi_transformer_dyquant,
    ops::FusedMultiTransformerDyquantOp,
    ops::FusedMultiTransformerDyquantOpOpMaker,
    paddle::framework::EmptyGradOpMaker<paddle::framework::OpDesc>,
    paddle::framework::EmptyGradOpMaker<paddle::imperative::OpBase>);

REGISTER_OP_VERSION(fused_multi_transformer_dyquant)
    .AddCheckpoint(
        R"ROC(
