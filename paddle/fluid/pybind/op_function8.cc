...
static PyObject * imperative_fused_conv3d(PyObject *self, PyObject *args, PyObject *kwargs)
{
  PyThreadState *tstate = nullptr;
  try
  {
    std::string op_type = "fused_conv3d";
    platform::RecordEvent op_type_record_event("fused_conv3d pybind_imperative_func");
...
static PyObject * imperative_fused_multihead_attention_variable(PyObject *self, PyObject *args, PyObject *kwargs)
{
  PyThreadState *tstate = nullptr;
  try
  {
    std::string op_type = "fused_multihead_attention_variable";
    platform::RecordEvent op_type_record_event("fused_multihead_attention_variable pybind_imperative_func");
    ...
    auto seq_lens = GetVarBaseFromArgs(op_type, "seq_lens", args, 3, false);
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(op_type, args, 4, PyTuple_GET_SIZE(args) , attrs);
    tstate = PyEval_SaveThread();
    
    imperative::NameVarBaseMap outs = {{"out", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}}};
    imperative::NameVarBaseMap ins = {{"query", {query}},{"key", {key}},{"value", {value}},{"seq_lens", {seq_lens}}};
...
static PyMethodDef ExtestMethods[] = {
  ...
  {"fused_conv3d", (PyCFunction)(void(*)(void))imperative_fused_conv3d, METH_VARARGS | METH_KEYWORDS, "C++ interface function for fused_conv3d in dygraph."},
  ...
  {"fused_multihead_attention_variable", (PyCFunction)(void(*)(void))imperative_fused_multihead_attention_variable, METH_VARARGS | METH_KEYWORDS, "C++ interface function for fused_multihead_attention_variable in dygraph."},
