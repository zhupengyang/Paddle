...
static PyObject * imperative_dgc(PyObject *self, PyObject *args, PyObject *kwargs)
{
  PyThreadState *tstate = nullptr;
  try
  {
    ...
    auto current_step = GetVarBaseFromArgs(op_type, "current_step", args, 4, false);
    ...
    imperative::NameVarBaseMap outs = {{"U_out", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}},{"V_out", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}},{"EncodeGrad", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}},{"Grad_out", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}},{"k", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}},{"GatherBuff", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}}};
    imperative::NameVarBaseMap ins = {{"U", {U}},{"V", {V}},{"Grad", {Grad}},{"Param", {Param}},{"current_step", {current_step}},{"nranks", {nranks}}};
    
    imperative::GetCurrentTracer()->TraceOp(op_type, ins, outs, attrs, {});
    PyEval_RestoreThread(tstate);
    tstate = nullptr;
    return MakeReturnPyObject(std::make_tuple(outs["U_out"][0],outs["V_out"][0],outs["EncodeGrad"][0],outs["Grad_out"][0],outs["k"][0],outs["GatherBuff"][0]));
  }
  catch(...) {
    if (tstate) {
      PyEval_RestoreThread(tstate);
...
static PyObject * imperative_fused_gemm_epilogue(PyObject *self, PyObject *args, PyObject *kwargs)
{
  PyThreadState *tstate = nullptr;
  try
  {
    std::string op_type = "fused_gemm_epilogue";
    platform::RecordEvent op_type_record_event("fused_gemm_epilogue pybind_imperative_func");
    ...
    imperative::NameVarBaseMap outs = {{"Out", {std::shared_ptr<imperative::VarBase>(new imperative::VarBase("auto_"+std::to_string(VarBaseUniqueNameID++)+"_"))}}};
    imperative::NameVarBaseMap ins = {{"X", {X}},{"Y", {Y}},{"Bias", {Bias}}};
...
static PyMethodDef ExtestMethods[] = {
  ...
  {"dgc", (PyCFunction)(void(*)(void))imperative_dgc, METH_VARARGS | METH_KEYWORDS, "C++ interface function for dgc in dygraph."},
  ...
  {"fused_gemm_epilogue", (PyCFunction)(void(*)(void))imperative_fused_gemm_epilogue, METH_VARARGS | METH_KEYWORDS, "C++ interface function for fused_gemm_epilogue in dygraph."},
