...
static PyObject * imperative_mp_allreduce_sum(PyObject *self, PyObject *args, PyObject *kwargs)
{
  PyThreadState *tstate = nullptr;
  try
  {
    std::string op_type = "mp_allreduce_sum";
    platform::RecordEvent op_type_record_event("mp_allreduce_sum pybind_imperative_func");
...
static PyObject * imperative_mp_allreduce_sum_(PyObject *self, PyObject *args, PyObject *kwargs)
{
  PyThreadState *tstate = nullptr;
  try
  {
...
static PyMethodDef ExtestMethods[] = {
  ...
  {"mp_allreduce_sum", (PyCFunction)(void(*)(void))imperative_mp_allreduce_sum, METH_VARARGS | METH_KEYWORDS, "C++ interface function for mp_allreduce_sum in dygraph."},
  {"mp_allreduce_sum_", (PyCFunction)(void(*)(void))imperative_mp_allreduce_sum_, METH_VARARGS | METH_KEYWORDS, "C++ interface function for mp_allreduce_sum_ in dygraph."},
